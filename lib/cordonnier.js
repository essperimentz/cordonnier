(function() {
  /*
  	Cordonnier v0.1
  */
  var MASTERS, buildFilters, buildOutput, injectLink, injectRule, injectScript, listen, readFields, shrinkicon, updatePreview;
  MASTERS = {};
  /* 
  ...
  */
  shrinkicon = function(dataURI, callback) {
    ...
    img = new Image();
    img.onload = function() {
      var URI, canvas, ctx, diff, height, max, width;
  ...
  */
  injectLink = function(master, link) {
    return master = master.replace(/<style/, "" + links + "\n\t<style");
  };
  /*
  ...
  */
  buildOutput = function(fields, isPreview) {
    ...
    reductor = function(master, filter) {
      return filter.call(null, master, fields, preview);
    };
